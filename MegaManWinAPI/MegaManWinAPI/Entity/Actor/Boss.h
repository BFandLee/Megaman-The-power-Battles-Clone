...
public:
	...
	void SetSuperArmor(bool isSuperArmor) { _isSuperArmor = isSuperArmor; }
	bool IsSuperArmor() const { return _isSuperArmor; }

	float GetHitDirX() const { return _hitDirX; }
